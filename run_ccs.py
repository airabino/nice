...
graph = nice.graph.graph_from_json('Data/graph_ccs_100k.json')
# graph = nice.graph.graph_from_json('Data/graph_nacs_100k.json')

# paths_all = json.load(open('Data/paths_100k.json', 'r'))
paths = json.load(open('Data/paths_ccs_100k.json', 'r'))
# paths = json.load(open('Data/paths_nacs_100k.json', 'r'))
