...
Loading
'''
# graph = nice.graph.graph_from_json('Data/graph_ccs_10u.json')
# graph = nice.graph.graph_from_json('Data/graph_ccs_25u.json')
graph = nice.graph.graph_from_json('Data/graph_ccs_50u.json')
# graph = nice.graph.graph_from_json('Data/graph_ccs_100u.json')

paths = json.load(open('Data/paths_ccs_100k.json', 'r'))

# save_path = '/media/aaron/Extreme SSD/nice_results/ccs_10u/'
# save_path = '/media/aaron/Extreme SSD/nice_results/ccs_25u/'
save_path = '/media/aaron/Extreme SSD/nice_results/ccs_50u/'
# save_path = '/media/aaron/Extreme SSD/nice_results/ccs_100u/'
